...
import type { BrowserRequestResult } from '@/TsModel/Alien/Orleans/Interfaces/BrowserRequestResult'
import type { BrowserServiceHealthInfo } from '@/TsModel/Alien/Orleans/Interfaces/BrowserServiceHealthInfo'
import type { BrowserShopInfo } from '@/TsModel/Alien/Orleans/Interfaces/BrowserShopInfo'
import type { HttpRequestItem } from '@/TsModel/Alien/Orleans/Entity/WebView/HttpRequestItem'
import type { ShowBrowserRequest } from '@/TsModel/Alien/Orleans/Entity/WebView/ShowBrowserRequest'
...
export class BrowserServiceGrainTestApi {
  ...
  /** 测试 Ping - 检查店铺浏览器是否在线 */
  async TestPing(/** 店铺ID */ shopId: string): Promise<string> {
  ...
  async TestInitialize(/** 店铺初始化请求 */ request: ShowBrowserRequest): Promise<string> {
    const config: AxiosRequestConfig = {
      method: 'POST',
...
根据店铺ID从数据库查询店铺信息，自动构建初始化请求 */
  async TestInitializeByShopId(/** 店铺ID */ shopId: string): Promise<string> {
    const config: AxiosRequestConfig = {
      method: 'POST',
  ...
  async TestGetShopInfo(/** 店铺ID */ shopId: string): Promise<BrowserShopInfo> {
    const config: AxiosRequestConfig = {
      method: 'GET',
  ...
  /** 测试 Close - 关闭店铺浏览器 */
  async TestClose(/** 店铺ID */ shopId: string): Promise<string> {
    const config: AxiosRequestConfig = {
      method: 'POST',
  ...
  async TestHttpRequest(/** 店铺ID */ shopId: string /** HTTP 请求参数 */, request: HttpRequestItem): Promise<string> {
    const config: AxiosRequestConfig = {
      method: 'POST',
  ...
  async TestExecuteScript(/** 店铺ID */ shopId: string /** JavaScript 脚本代码 */, script: string): Promise<string> {
    const config: AxiosRequestConfig = {
      method: 'POST',
  ...
  /** 测试 Navigate - 跳转到指定地址 */
  async TestNavigate(/** 店铺ID */ shopId: string /** 目标 URL 地址 */, url: string): Promise<string> {
    const config: AxiosRequestConfig = {
      method: 'POST',
  ...
  async TestGetCookieString(/** 店铺ID */ shopId: string): Promise<string> {
    const config: AxiosRequestConfig = {
      method: 'GET',
  ...
  async TestIsOpen(/** 店铺ID */ shopId: string): Promise<boolean> {
    const config: AxiosRequestConfig = {
      method: 'GET',
  ...
  async TestGetHealthInfo(/** 店铺ID */ shopId: string): Promise<BrowserServiceHealthInfo> {
    const config: AxiosRequestConfig = {
      method: 'GET',
...
5. 获取 Cookie
6. 关闭浏览器 */
  async TestFullFlow(/** 店铺初始化请求 */ request: ShowBrowserRequest): Promise<any> {
    const config: AxiosRequestConfig = {
      method: 'POST',
  ...
  /** 测试执行简单脚本 - 获取页面标题 */
  async TestGetPageTitle(/** 店铺ID */ shopId: string): Promise<string> {
    const config: AxiosRequestConfig = {
      method: 'GET',
  ...
  /** 测试执行简单脚本 - 获取当前 URL */
  async TestGetCurrentUrl(/** 店铺ID */ shopId: string): Promise<string> {
    const config: AxiosRequestConfig = {
      method: 'GET',
  ...
  /** 批量测试多个店铺的 Ping 状态 */
  async TestBatchPing(/** 店铺ID列表 */ shopIds: string[]): Promise<Record<string, string>> {
    const config: AxiosRequestConfig = {
      method: 'POST',
  ...
  /** 批量获取多个店铺的健康状态 */
  async TestBatchHealthInfo(/** 店铺ID列表 */ shopIds: string[]): Promise<BrowserServiceHealthInfo[]> {
    const config: AxiosRequestConfig = {
      method: 'POST',
