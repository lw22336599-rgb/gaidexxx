...
import type { GenerateTypescriptRequest } from '@/TsModel/Alien/Faster/Controllers/Sys/GenerateTypescriptRequest'
...
export class TypescriptGeneratorApi {
  ...
  async GenerateTypescriptToDirectory(
    /** 生成配置请求体 */
  ...
  /** 预览生成的TypeScript内容 */
  async PreviewTypescript(
    /** 预览类型 (models|api|enums) */
