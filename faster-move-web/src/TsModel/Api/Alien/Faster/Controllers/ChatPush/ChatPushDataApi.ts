...
import type { BatchChatPushPush_parm } from '@/TsModel/Alien/Entity/Function/CHATPUSH/BatchChatPushPush_parm'
...
export class ChatPushDataApi {
  ...
  /** 立即推送数据(不需要判断发送时机) */
  async PushDataNow(/** 店铺ID */ shopId: string): Promise<any> {
    const config: AxiosRequestConfig = {
      method: 'POST',
