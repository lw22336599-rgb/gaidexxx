...
import type { RuleForType } from '@/TsModel/Alien/Entity/Function/FOODMOVE/RuleForType'
...
export class FdmvRuleApi {
  ...
  /** 添加商品复制规则 */
  async AddRule(/** 规则信息 */ rule: AddFdmvRuleParmsVo): Promise<t_wmt_fc_fdmv_rule> {
  ...
  /** 更新商品复制规则 */
  async UpdateRule(/** 规则信息 */ rule: UpdateFdmvRuleParmsVo): Promise<boolean> {
    const config: AxiosRequestConfig = {
      method: 'POST',
  ...
  /** 删除商品复制规则 */
  async DeleteRule(/** 规则ID */ id: string): Promise<boolean> {
    const config: AxiosRequestConfig = {
      method: 'POST',
  ...
  /** 批量删除商品复制规则 */
  async DeleteRules(/** 规则ID列表 */ ids: string[]): Promise<boolean> {
    const config: AxiosRequestConfig = {
      method: 'POST',
  ...
  /** 获取商品复制规则列表（分页） */
  async GetRuleList(/** 查询参数 */ parms: GetFdmvRuleListParmsVo): Promise<PageResultVo<t_wmt_fc_fdmv_rule>> {
    const config: AxiosRequestConfig = {
      method: 'POST',
  ...
  /** 根据ID获取规则详情 */
  async GetRuleById(/** 规则ID */ id: string): Promise<t_wmt_fc_fdmv_rule> {
    const config: AxiosRequestConfig = {
      method: 'GET',
  ...
  /** 将规则加入到分组 */
  async ConnectGroup(/** 分组参数 */ parms: ConnectRuleGroupParmsVo): Promise<void> {
    const config: AxiosRequestConfig = {
      method: 'POST',
  ...
  /** 将规则移出分组 */
  async RemoveGroup(/** 分组参数 */ parms: ConnectRuleGroupParmsVo): Promise<void> {
    const config: AxiosRequestConfig = {
      method: 'POST',
  ...
  /** 获取指定店铺类型的所有规则 */
  async GetRulesByShopType(
    /** 店铺类型 */
    shopType: ShopType /** 规则类型（可选） */,
    forType?: RuleForType
  ): Promise<t_wmt_fc_fdmv_rule[]> {
    const config: AxiosRequestConfig = {
      method: 'GET',
