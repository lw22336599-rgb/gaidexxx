...
import type { BatchEnable_func_parm } from '@/TsModel/Alien/Controllers/Function/BatchEnable_func_parm'
import type { BatchOperationResult } from '@/TsModel/Alien/Entity/Function/BatchOperationResult'
import type { BatchSetConf_func_parm } from '@/TsModel/Alien/Entity/Function/BatchSetConf_func_parm'
import type { Call_func_parm } from '@/TsModel/Alien/Entity/Function/Call_func_parm'
import type { Call_parm } from '@/TsModel/Alien/Entity/Function/Call_parm'
import type { CallFuinctionParms } from '@/TsModel/Alien/Controllers/Function/CallFuinctionParms'
import type { Enable_func_parm } from '@/TsModel/Alien/Controllers/Function/Enable_func_parm'
import type { Get_FunctionLog_parm } from '@/TsModel/Alien/Entity/Function/Get_FunctionLog_parm'
import type { GetConf_func_parm } from '@/TsModel/Alien/Entity/Function/GetConf_func_parm'
import type { GetConf_func_res } from '@/TsModel/Alien/Entity/Function/GetConf_func_res'
import type { SetConf_func_parm } from '@/TsModel/Alien/Entity/Function/SetConf_func_parm'
...
export class FunctionUserApi {
  ...
  async GetFuncInfo(/** 功能code */ funcCode: string, shopId: string): Promise<any> {
    const config: AxiosRequestConfig = {
      method: 'GET',
