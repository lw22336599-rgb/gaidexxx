...
import type { GetFuncConfSchemasParm } from '@/TsModel/Alien/Controllers/Function/GetFuncConfSchemasParm'
import type { GetFuncJobInfoPageParm } from '@/TsModel/Alien/Controllers/Function/GetFuncJobInfoPageParm'
import type { GetFuncRunTaskPageParm } from '@/TsModel/Alien/Controllers/Function/GetFuncRunTaskPageParm'
import type { ShopType } from '@/TsModel/Alien/Entity/Enums/ShopType'
import type { t_ls_job_info } from '@/TsModel/Alien/Entity/Tables/Job/t_ls_job_info'
import type { t_wmt_func_run_task } from '@/TsModel/Alien/Entity/Tables/function/t_wmt_func_run_task'
import type { TriggerFuncRunParm } from '@/TsModel/Alien/Controllers/Function/TriggerFuncRunParm'
...
export class FuncRunTaskApi {
  ...
  async GetShopGroups(/** 店铺ID */ shopId: string): Promise<FoodGroupItem[]> {
  ...
  async GetFuncConfSchema(/** 店铺类型 */ shopType: ShopType /** 功能代码 */, funcCode: string): Promise<string> {
    const config: AxiosRequestConfig = {
      method: 'GET',
  ...
  async GetFuncConfSchemas(/** 查询参数 */ parm: GetFuncConfSchemasParm): Promise<FuncConfSchemaResult[]> {
    const config: AxiosRequestConfig = {
      method: 'POST',
