...
import type { BatchPayShop_Result } from '@/TsModel/Alien/Controllers/Function/BatchPayShop_Result'
import type { BatchPayShopV2_Parm } from '@/TsModel/Alien/Controllers/Function/BatchPayShopV2_Parm'
...
import type { GetFunctionPrices_result_itemV2 } from '@/TsModel/Alien/Controllers/Function/GetFunctionPrices_result_itemV2'
import type { PayAdminFuncV2_Parm } from '@/TsModel/Alien/Controllers/Function/PayAdminFuncV2_Parm'
import type { PayShop_resultV2 } from '@/TsModel/Alien/Controllers/Shop/PayShop_resultV2'
import type { PayShopV2_Parm } from '@/TsModel/Alien/Controllers/Function/PayShopV2_Parm'
...
export class FunctionPriceApi {
  ...
  /** 获取功能列表 */
  async GetFuncList(/** 门店类型 */ shopType: ShopType): Promise<t_wmt_function[]> {
    const config: AxiosRequestConfig = {
      method: 'GET',
  ...
  async GetPricePageList(
    /** 分页与筛选参数(包含可选价格名称与功能代码筛选) */
    parms: GetFunctionPricePageParm
  ): Promise<PageResultVo<FunctionPriceWithFuncNameVo>> {
    const config: AxiosRequestConfig = {
      method: 'POST',
  ...
  async GetFunctionPrices(
    ...
    isKeyWord: boolean
  ): Promise<GetFunctionPrices_result_itemV2[]> {
    const config: AxiosRequestConfig = {
      method: 'GET',
  ...
  /** 启用或禁用某个功能价格(仅限管理员) */
  async SetPriceEnable(/** 价格ID */ id: string /** true 表示启用, false 表示禁用 */, enable: boolean): Promise<void> {
    const config: AxiosRequestConfig = {
      method: 'POST',
  ...
  async UpdatePrice(
    /** 要修改的价格实体(必须包含有效的 id) */
    price: t_wmt_function_price
  ): Promise<t_wmt_function_price> {
    const config: AxiosRequestConfig = {
      method: 'POST',
  ...
  /** 删除指定的功能价格(仅限管理员) */
  async DeletePrice(/** 要删除的价格ID */ id: string): Promise<void> {
    const config: AxiosRequestConfig = {
      method: 'POST',
  ...
  async GetPriceById(/** 价格ID */ id: string): Promise<FunctionPriceWithFuncNameVo> {
    const config: AxiosRequestConfig = {
      method: 'GET',
