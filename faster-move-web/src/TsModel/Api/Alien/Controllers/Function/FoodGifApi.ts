...
import type { ConnectGifGroupParms } from '@/TsModel/Alien/Controllers/Function/ConnectGifGroupParms'
import type { GetGifListParmsVo } from '@/TsModel/Alien/Controllers/Function/GetGifListParmsVo'
import type { t_wmt_fc_foodgif_list } from '@/TsModel/Alien/Entity/Tables/function/foodGif/t_wmt_fc_foodgif_list'
...
export class FoodGifApi {
  ...
  /** 删除动图 */
  async DeleteGif(/** 动图id */ ids: string[]): Promise<void> {
    const config: AxiosRequestConfig = {
      method: 'POST',
