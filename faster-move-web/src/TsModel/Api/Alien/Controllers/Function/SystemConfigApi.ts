...
import type { SystemConfigUpdateDto } from '@/TsModel/Alien/Entity/Function/SystemConfig/SystemConfigUpdateDto'
...
export class SystemConfigApi {
  ...
  /** 根据 key 获取配置值 */
  async GetConfigByKey(/** 配置键 */ key: string): Promise<string> {
    const config: AxiosRequestConfig = {
      method: 'GET',
