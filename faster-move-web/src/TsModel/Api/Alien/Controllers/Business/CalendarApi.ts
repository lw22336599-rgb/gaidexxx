...
import type { CalendarState } from '@/TsModel/Alien/Entity/Enums/Business/CalendarState'
import type { CalendarType } from '@/TsModel/Alien/Entity/Enums/Business/CalendarType'
...
export class CalendarApi {
  ...
  async GetList(
    pageIndex: number,
    pageSize: number,
    type: CalendarType /** 如果为0 将获取全部状态 */,
    state: CalendarState
  ): Promise<PageResultVo<t_biz_calendar>> {
    const config: AxiosRequestConfig = {
      method: 'GET',
