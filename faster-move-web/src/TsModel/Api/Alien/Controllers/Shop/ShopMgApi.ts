...
import type { Add_Shop_Agency_parm } from '@/TsModel/Alien/Entity/ShopLogin/Add_Shop_Agency_parm'
import type { BatchAssignShopsResult } from '@/TsModel/Alien/Controllers/Shop/BatchAssignShopsResult'
import type { BatchAssignShopsVo } from '@/TsModel/Alien/Controllers/Shop/BatchAssignShopsVo'
import type { BatchUnassignShopsResult } from '@/TsModel/Alien/Controllers/Shop/BatchUnassignShopsResult'
import type { BatchUnassignShopsVo } from '@/TsModel/Alien/Controllers/Shop/BatchUnassignShopsVo'
import type { Delete_Shop_parm } from '@/TsModel/Alien/Controllers/Shop/Delete_Shop_parm'
import type { Delete_UnBonding_parm } from '@/TsModel/Alien/Controllers/Shop/Delete_UnBonding_parm'
import type { FuncInfo_ResulItem } from '@/TsModel/Alien/Controllers/Shop/FuncInfo_ResulItem'
import type { Get_ShopList_parm } from '@/TsModel/Alien/Controllers/Shop/Get_ShopList_parm'
import type { GetShopsByOfficeIdsParm } from '@/TsModel/Alien/Controllers/Shop/GetShopsByOfficeIdsParm'
import type { GetShopsByOfficeIdsResult } from '@/TsModel/Alien/Controllers/Shop/GetShopsByOfficeIdsResult'
import type { Info } from '@/TsModel/Alien/Entity/Function/APPDATA/Info'
import type { OfficeAuthResult } from '@/TsModel/Alien/Controllers/Shop/OfficeAuthResult'
import type { ShopAuthErrorCount } from '@/TsModel/Alien/Controllers/Shop/ShopAuthErrorCount'
import type { ShopComprehensiveStats } from '@/TsModel/Alien/Controllers/Shop/ShopComprehensiveStats'
import type { ShopFuncCount } from '@/TsModel/Alien/Controllers/Shop/ShopFuncCount'
...
import type { ShopLoginParms } from '@/TsModel/Alien/Entity/ShopLogin/ShopLoginParms'
import type { ShopLoginResult } from '@/TsModel/Alien/Entity/ShopLogin/ShopLoginResult'
...
import type { Update_Shop_parm } from '@/TsModel/Alien/Controllers/Shop/Update_Shop_parm'
...
export class ShopMgApi {
  ...
  /** 解除用户对店铺的绑定 */
  async UnShopBind(/** 店铺id */ shopId: string /** 用户id */, shopUserId: string): Promise<void> {
    const config: AxiosRequestConfig = {
      method: 'POST',
  ...
  /** 获取所有功能的到期信息统计 */
  async GetFuncCount(/** 店铺类型 */ shopType?: ShopType): Promise<Record<string, ShopFuncCount>> {
    const config: AxiosRequestConfig = {
      method: 'GET',
  ...
  /** 获取各平台授权异常的店铺数量统计 */
  async GetAuthErrorCount(
    /** 指定平台（可选，为null时统计所有平台） */
    shopType?: ShopType
  ): Promise<ShopAuthErrorCount[]> {
    const config: AxiosRequestConfig = {
      method: 'GET',
  ...
  async GetComprehensiveStats(
    /** 店铺类型（可选，为null时统计所有平台） */
    shopType?: ShopType
  ): Promise<ShopComprehensiveStats> {
    const config: AxiosRequestConfig = {
      method: 'GET',
...
只能给自己的下级用户分配，且只能分配自己管理的店铺 */
  async BatchAssignShopsToUser(
    /** 批量分配参数，包含用户ID和店铺ID列表 */
    parms: BatchAssignShopsVo
  ): Promise<BatchAssignShopsResult> {
    const config: AxiosRequestConfig = {
      method: 'POST',
...
只返回当前用户有权限管理的店铺中，未分配给目标用户的店铺 */
  async GetUnassignedShopsForUser(
    /** 目标用户ID */
    userId: string /** 页码 */,
    page: number /** 每页数量 */,
    ...
    keyword?: string
  ): Promise<PageResultVo<UserAssignedShopVo>> {
    const config: AxiosRequestConfig = {
      method: 'GET',
...
只能操作自己的下级用户，且只能取消自己有权限管理的店铺 */
  async BatchUnassignShopsFromUser(
    /** 批量取消分配参数 */
    parms: BatchUnassignShopsVo
  ): Promise<BatchUnassignShopsResult> {
    const config: AxiosRequestConfig = {
      method: 'POST',
