...
import type { AdminFunctionVo } from '@/TsModel/Alien/Entity/Tables/function/AdminFunctionVo'
import type { AgencyForgetResVo } from '@/TsModel/Alien/Controllers/Admin/AgencyForgetResVo'
import type { AgencyForgetVo } from '@/TsModel/Alien/Controllers/Admin/AgencyForgetVo'
import type { AgencyLoginByPhoneAndGaCodeVo } from '@/TsModel/Alien/Controllers/Admin/AgencyLoginByPhoneAndGaCodeVo'
import type { AgencyLoginVo } from '@/TsModel/Alien/Controllers/Admin/AgencyLoginVo'
import type { AgencyRegVo } from '@/TsModel/Alien/Controllers/Admin/AgencyRegVo'
import type { AppUserLoginRes } from '@/TsModel/Alien/Entity/AppUserLoginRes'
import type { DisableGoogleAuthenticatorVo } from '@/TsModel/Alien/Controllers/Admin/DisableGoogleAuthenticatorVo'
import type { EnableGoogleAuthenticatorRes } from '@/TsModel/Alien/Controllers/Admin/EnableGoogleAuthenticatorRes'
import type { GetAgencyInfoVo_Result } from '@/TsModel/Alien/Controllers/Admin/GetAgencyInfoVo_Result'
import type { GetGoogleAuthenticatorSecretRes } from '@/TsModel/Alien/Controllers/Admin/GetGoogleAuthenticatorSecretRes'
import type { GetUserGoogleAuthCodeRes } from '@/TsModel/Alien/Controllers/Admin/GetUserGoogleAuthCodeRes'
import type { GetUserGoogleAuthCodeVo } from '@/TsModel/Alien/Controllers/Admin/GetUserGoogleAuthCodeVo'
import type { GiveIntegral_parms } from '@/TsModel/Alien/Controllers/Admin/GiveIntegral_parms'
import type { RemoveSubordinateRolesVo } from '@/TsModel/Alien/Controllers/Admin/RemoveSubordinateRolesVo'
import type { ResetGoogleAuthenticatorVo } from '@/TsModel/Alien/Controllers/Admin/ResetGoogleAuthenticatorVo'
import type { SetSubordinateRolesVo } from '@/TsModel/Alien/Controllers/Admin/SetSubordinateRolesVo'
import type { ShopType } from '@/TsModel/Alien/Entity/Enums/ShopType'
import type { t_sc_admin } from '@/TsModel/Alien/Entity/Tables/Users/t_sc_admin'
import type { VerifyGoogleAuthenticatorSetupOnLoginVo } from '@/TsModel/Alien/Controllers/Admin/VerifyGoogleAuthenticatorSetupOnLoginVo'
import type { VerifyGoogleAuthenticatorSetupVo } from '@/TsModel/Alien/Controllers/Admin/VerifyGoogleAuthenticatorSetupVo'
...
export class AdminApi {
  ...
  /** 添加用户 */
  async AddUser(/** 手机号 */ phone: string, is_boss: boolean): Promise<t_sc_admin> {
    const config: AxiosRequestConfig = {
      method: 'POST',
  ...
  /** 通过手机号和谷歌验证码登录 */
  async AgencyLoginByPhoneAndGaCode(
    /** 包含手机号和谷歌验证码的参数 */
    parm: AgencyLoginByPhoneAndGaCodeVo
  ): Promise<AppUserLoginRes> {
    const config: AxiosRequestConfig = {
      method: 'POST',
...
用于已登录用户绑定 */
  ...
  async BindGoogleAuthenticatorOnLogin(
    /** 包含用户名和密码的参数 */
    parm: AgencyLoginVo
  ): Promise<EnableGoogleAuthenticatorRes> {
    const config: AxiosRequestConfig = {
      method: 'POST',
  ...
  async VerifyGoogleAuthenticatorSetup(/** 包含验证码的参数 */ parm: VerifyGoogleAuthenticatorSetupVo): Promise<void> {
    const config: AxiosRequestConfig = {
      method: 'POST',
  ...
  async VerifyGoogleAuthenticatorSetupOnLogin(
    /** 包含用户名、密码和验证码的参数 */
    parm: VerifyGoogleAuthenticatorSetupOnLoginVo
  ): Promise<AppUserLoginRes> {
    const config: AxiosRequestConfig = {
      method: 'POST',
...
用于保存到用户电脑上，以便自动计算验证码进行登录 */
  ...
  async DisableGoogleAuthenticator(/** 包含当前密码的参数 */ parm: DisableGoogleAuthenticatorVo): Promise<void> {
    const config: AxiosRequestConfig = {
      method: 'POST',
...
清除目标用户的谷歌验证码密钥和启用状态，用户需要重新绑定 */
  async ResetGoogleAuthenticator(/** 包含目标用户ID的参数 */ parm: ResetGoogleAuthenticatorVo): Promise<void> {
    const config: AxiosRequestConfig = {
      method: 'POST',
  ...
  async GetUserGoogleAuthCode(
    /** 包含目标用户ID的参数 */
    parm: GetUserGoogleAuthCodeVo
  ): Promise<GetUserGoogleAuthCodeRes> {
    const config: AxiosRequestConfig = {
      method: 'POST',
  ...
  async SetSubordinateRoles(
    /** 包含目标用户ID列表和要设置的单个角色的参数 */
    parm: SetSubordinateRolesVo
  ): Promise<void> {
    const config: AxiosRequestConfig = {
      method: 'POST',
  ...
  async RemoveSubordinateRoles(
    /** 包含目标用户ID列表和要移除的单个角色的参数 */
    parm: RemoveSubordinateRolesVo
  ): Promise<void> {
    const config: AxiosRequestConfig = {
      method: 'POST',
