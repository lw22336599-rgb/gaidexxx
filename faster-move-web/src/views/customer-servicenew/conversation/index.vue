    ...
    <div class="sidebar">
      ...
      <div v-if="showTodoMessagePage" class="todo-message-page">
        ...
        <div class="todo-message-list">
          <div
            v-for="tagGroup in todoMessagesByTag"
            :key="tagGroup.tag"
            class="todo-tag-group"
          >
            <!-- 分组标题 -->
            <div class="tag-group-header">
              <div class="tag-bookmark" :style="{ color: tagGroup.tagColor }">
                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M3 2.5C3 1.67157 3.67157 1 4.5 1H11.5C12.3284 1 13 1.67157 13 2.5V13.5C13 13.7652 12.8946 14.0196 12.7071 14.2071C12.5196 14.3946 12.2652 14.5 12 14.5C11.7348 14.5 11.4804 14.3946 11.2929 14.2071L8 10.9142L4.70711 14.2071C4.51957 14.3946 4.26522 14.5 4 14.5C3.73478 14.5 3.48043 14.3946 3.29289 14.2071C3.10536 14.0196 3 13.7652 3 13.5V2.5ZM4.5 2.5V13.5L8 10L11.5 13.5V2.5H4.5Z" :fill="tagGroup.tagColor"/>
                </svg>
              </div>
            ...
            <div class="conversation-content">
              <div class="conversation-header">
                ...
                <div class="header-right-info">
                  <span v-if="item.todoTag" class="todo-badge">
                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
                      <path d="M3 2.5C3 1.67157 3.67157 1 4.5 1H11.5C12.3284 1 13 1.67157 13 2.5V13.5C13 13.7652 12.8946 14.0196 12.7071 14.2071C12.5196 14.3946 12.2652 14.5 12 14.5C11.7348 14.5 11.4804 14.3946 11.2929 14.2071L8 10.9142L4.70711 14.2071C4.51957 14.3946 4.26522 14.5 4 14.5C3.73478 14.5 3.48043 14.3946 3.29289 14.2071C3.10536 14.0196 3 13.7652 3 13.5V2.5ZM4.5 2.5V13.5L8 10L11.5 13.5V2.5H4.5Z" :fill="getTagColor(item.todoTag)"/>
                    </svg>
                  </span>
                  <span v-if="item.isPinned" class="pin-badge">
                    <span class="pin-icon-small" v-html="pinIcon"></span>
                  </span>
              ...
              <div class="conversation-preview">
                <div class="preview-content-wrapper">
                  ...
                  <span v-else-if="item.unrepliedMinutes && item.unrepliedMinutes > 3" class="message-status-tag unreplied-tag">超过3分钟未回复的顾客</span>
                ...
                >
                  ...
                  <div class="message-menu-content">
                    <div class="menu-item" @click="handlePinMessage(item)">
                      <span class="menu-icon" style="margin-right: 5px;" v-html="item.isPinned ? unpinIcon.replace('currentColor', '#2c2c2c') : pinIcon.replace('currentColor', '#2c2c2c')"></span>
                      <span class="menu-text">{{ item.isPinned ? '取消置顶' : '置顶消息' }}</span>
                    </div>
                    <div class="menu-divider" style="height: 1px; background-color: #e4e7ed; margin: 12px 0; padding: 0;"></div>
                    <el-popover
                      placement="right"
                      :width="120"
                      trigger="hover"
                    ...
                    >
                      <template #reference>
                        <div class="menu-item">
                          <span class="menu-icon" style="margin-right: 5px;">
                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
                              <path d="M3 2.5C3 1.67157 3.67157 1 4.5 1H11.5C12.3284 1 13 1.67157 13 2.5V13.5C13 13.7652 12.8946 14.0196 12.7071 14.2071C12.5196 14.3946 12.2652 14.5 12 14.5C11.7348 14.5 11.4804 14.3946 11.2929 14.2071L8 10.9142L4.70711 14.2071C4.51957 14.3946 4.26522 14.5 4 14.5C3.73478 14.5 3.48043 14.3946 3.29289 14.2071C3.10536 14.0196 3 13.7652 3 13.5V2.5ZM4.5 2.5V13.5L8 10L11.5 13.5V2.5H4.5Z" fill="#2c2c2c"/>
                            </svg>
                          </span>
                      ...
                      <div class="todo-menu-content" style="display: flex; flex-direction: column; gap: 0; width: 100%;">
                        <div class="todo-menu-item" @click="handleMarkTodoTag(item, 'invoice')" style="display: flex; align-items: center; flex-direction: row; flex-wrap: nowrap; gap: 8px; padding: 10px 12px; white-space: nowrap; width: 100%; box-sizing: border-box;">
                          <div class="todo-menu-icon" style="display: flex; align-items: center; justify-content: center; width: 16px; height: 16px; flex-shrink: 0; margin: 0; padding: 0;">
                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" style="width: 16px; height: 16px; display: block;">
                              <path d="M3 2.5C3 1.67157 3.67157 1 4.5 1H11.5C12.3284 1 13 1.67157 13 2.5V13.5C13 13.7652 12.8946 14.0196 12.7071 14.2071C12.5196 14.3946 12.2652 14.5 12 14.5C11.7348 14.5 11.4804 14.3946 11.2929 14.2071L8 10.9142L4.70711 14.2071C4.51957 14.3946 4.26522 14.5 4 14.5C3.73478 14.5 3.48043 14.3946 3.29289 14.2071C3.10536 14.0196 3 13.7652 3 13.5V2.5ZM4.5 2.5V13.5L8 10L11.5 13.5V2.5H4.5Z" fill="#409EFF"/>
                            </svg>
                          </div>
                          <span class="todo-menu-text" style="white-space: nowrap; margin: 0; padding: 0;">开发票</span>
                        </div>
                        <div class="todo-menu-item" @click="handleMarkTodoTag(item, 'complaint')" style="display: flex; align-items: center; flex-direction: row; flex-wrap: nowrap; gap: 8px; padding: 10px 12px; white-space: nowrap; width: 100%; box-sizing: border-box;">
                          <div class="todo-menu-icon" style="display: flex; align-items: center; justify-content: center; width: 16px; height: 16px; flex-shrink: 0; margin: 0; padding: 0;">
                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" style="width: 16px; height: 16px; display: block;">
                              <path d="M3 2.5C3 1.67157 3.67157 1 4.5 1H11.5C12.3284 1 13 1.67157 13 2.5V13.5C13 13.7652 12.8946 14.0196 12.7071 14.2071C12.5196 14.3946 12.2652 14.5 12 14.5C11.7348 14.5 11.4804 14.3946 11.2929 14.2071L8 10.9142L4.70711 14.2071C4.51957 14.3946 4.26522 14.5 4 14.5C3.73478 14.5 3.48043 14.3946 3.29289 14.2071C3.10536 14.0196 3 13.7652 3 13.5V2.5ZM4.5 2.5V13.5L8 10L11.5 13.5V2.5H4.5Z" fill="#F56C6C"/>
                            </svg>
                          </div>
                          <span class="todo-menu-text" style="white-space: nowrap; margin: 0; padding: 0;">投诉</span>
                        </div>
                        <div class="todo-menu-item" @click="handleMarkTodoTag(item, 'cancel')" style="display: flex; align-items: center; flex-direction: row; flex-wrap: nowrap; gap: 8px; padding: 10px 12px; white-space: nowrap; width: 100%; box-sizing: border-box;">
                          <div class="todo-menu-icon" style="display: flex; align-items: center; justify-content: center; width: 16px; height: 16px; flex-shrink: 0; margin: 0; padding: 0;">
                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" style="width: 16px; height: 16px; display: block;">
                              <path d="M3 2.5C3 1.67157 3.67157 1 4.5 1H11.5C12.3284 1 13 1.67157 13 2.5V13.5C13 13.7652 12.8946 14.0196 12.7071 14.2071C12.5196 14.3946 12.2652 14.5 12 14.5C11.7348 14.5 11.4804 14.3946 11.2929 14.2071L8 10.9142L4.70711 14.2071C4.51957 14.3946 4.26522 14.5 4 14.5C3.73478 14.5 3.48043 14.3946 3.29289 14.2071C3.10536 14.0196 3 13.7652 3 13.5V2.5ZM4.5 2.5V13.5L8 10L11.5 13.5V2.5H4.5Z" fill="#E6A23C"/>
                            </svg>
                          </div>
                          <span class="todo-menu-text" style="white-space: nowrap; margin: 0; padding: 0;">取消退换</span>
                        </div>
                        <div class="todo-menu-item" @click="handleMarkTodoTag(item, 'exchange')" style="display: flex; align-items: center; flex-direction: row; flex-wrap: nowrap; gap: 8px; padding: 10px 12px; white-space: nowrap; width: 100%; box-sizing: border-box;">
                          <div class="todo-menu-icon" style="display: flex; align-items: center; justify-content: center; width: 16px; height: 16px; flex-shrink: 0; margin: 0; padding: 0;">
                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" style="width: 16px; height: 16px; display: block;">
                              <path d="M3 2.5C3 1.67157 3.67157 1 4.5 1H11.5C12.3284 1 13 1.67157 13 2.5V13.5C13 13.7652 12.8946 14.0196 12.7071 14.2071C12.5196 14.3946 12.2652 14.5 12 14.5C11.7348 14.5 11.4804 14.3946 11.2929 14.2071L8 10.9142L4.70711 14.2071C4.51957 14.3946 4.26522 14.5 4 14.5C3.73478 14.5 3.48043 14.3946 3.29289 14.2071C3.10536 14.0196 3 13.7652 3 13.5V2.5ZM4.5 2.5V13.5L8 10L11.5 13.5V2.5H4.5Z" fill="#67C23A"/>
                            </svg>
                          </div>
                          <span class="todo-menu-text" style="white-space: nowrap; margin: 0; padding: 0;">换货补送</span>
                        </div>
                      </div>
                    </el-popover>
                  </div>
          ...
          <div class="chat-header">
            ...
            <div class="header-right">
              ...
              <el-button class="pin-btn" @click="togglePin">
                <span class="pin-icon" v-html="isPinned ? unpinIcon : pinIcon"></span>
              </el-button>
            </div>
          </div>
            ...
            <div class="input-wrapper" ref="inputWrapperRef">
              ...
              >
                ...
                >
                  ...
                  <div class="autocomplete-content" v-html="highlightKeyword(match.content, messageInput.trim())"></div>
                </div>
              </div>
          ...
          <div v-if="activeDetailTab === 'quick-reply'" class="quick-reply-section">
            ...
            <div class="quick-reply-toolbar">
              ...
              <div class="toolbar-actions">
                <el-button class="import-export-btn" @click="handleImportScript">
                  导入
                </el-button>
                <el-button class="import-export-btn" @click="handleExportScript">
                  分享
                </el-button>
            ...
            <div class="quick-reply-groups">
              ...
              >
                <div class="group-header" @click="toggleGroup(group.id)">
                  ...
                  <div class="group-icon" v-if="group.icon">
                  ...
                  <div v-if="group.name !== '常用回复'" class="group-actions">
                    ...
                    >
                      <svg width="16" height="16" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg">
                        <path d="M489.344 233.408a32 32 0 0 1 45.248 0l170.688 170.624a32 32 0 1 1-45.248 45.248L544 333.248v605.44a32 32 0 0 1-64 0v-605.44L363.904 449.28a32 32 0 1 1-45.184-45.248zM53.312 85.312a32 32 0 0 1 32-32h853.312a32 32 0 0 1 0 64H85.12a32 32 0 0 1-32-32" fill="#8a8a8a"></path>
                      </svg>
                    </div>
                    <div class="action-icon" @click.stop="handleMoveDownGroup(group.id)">
                      <svg width="16" height="16" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg">
                        <path d="M53.376 938.688a32 32 0 0 1 32-32h853.312a32 32 0 0 1 0 64H85.376a32 32 0 0 1-32-32M512 53.312a32 32 0 0 1 32 32v605.44l116.096-116.032a32 32 0 0 1 45.184 45.248l-170.624 170.624a32 32 0 0 1-45.248 0L318.72 619.968a32 32 0 0 1 45.248-45.248L480 690.752v-605.44a32 32 0 0 1 32-32" fill="#8a8a8a"></path>
                      </svg>
                    </div>
                    ...
                    <div class="action-icon" @click.stop="handleEditGroup(group.id)">
                      <svg width="16" height="16" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg">
                        <path d="M622.336 214.016l169.728 169.792 88.576-88.576a53.888 53.888 0 0 0 0-76.224l-93.568-93.504a53.824 53.824 0 0 0-76.16 0zM261.632 914.24l484.736-484.736-169.792-169.728-481.536 481.6a10.56 10.56 0 0 0-3.2 7.552v154.56a10.752 10.752 0 0 0 10.752 10.752z m403.584-834.496a118.464 118.464 0 0 1 167.552 0l93.568 93.568a118.528 118.528 0 0 1 0 167.616l-573.312 573.312h611.392a32.32 32.32 0 1 1 0 64.64H102.592a75.392 75.392 0 0 1-75.392-75.392v-154.56a75.52 75.52 0 0 1 22.08-53.248z" fill="#8a8a8a"></path>
                      </svg>
                    </div>
                    <div class="action-icon" @click.stop="handleDeleteGroup(group.id)">
                      <svg width="16" height="16" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg">
                        <path d="M595.2 397.44a30.72 30.72 0 0 1 31.36 31.36v333.44a31.36 31.36 0 1 1-64 0V428.8a30.72 30.72 0 0 1 30.72-31.36M428.8 397.44a30.72 30.72 0 0 1 30.72 31.36v333.44a31.36 31.36 0 1 1-64 0V428.8a30.72 30.72 0 0 1 31.36-31.36" fill="#8a8a8a"></path>
                        <path d="M887.68 188.16h-218.88v-51.84a115.84 115.84 0 0 0-115.2-115.2h-83.2a115.84 115.84 0 0 0-115.2 115.2v51.84H136.32a31.36 31.36 0 0 0 0 64h13.44l72.32 648.32a115.2 115.2 0 0 0 113.92 102.4h352a115.2 115.2 0 0 0 113.92-102.4l72.32-649.6h13.44a31.36 31.36 0 1 0 0-64z m-469.76-51.84a52.48 52.48 0 0 1 52.48-52.48h83.2a52.48 52.48 0 0 1 52.48 52.48v51.84H417.92z m320 757.12a52.48 52.48 0 0 1-51.84 46.72H336a52.48 52.48 0 0 1-51.84-44.16L213.12 256h597.76z" fill="#8a8a8a"></path>
                      </svg>
                    </div>
                  </div>
                </div>
                <div v-show="!group.collapsed" class="group-content">
                  <div v-if="group.items && group.items.length > 0" class="group-items">
                    <div
                      ...
                      draggable="true"
                      @dragstart="handleDragStart(group.id as number | string, item.id as number | string, itemIndex, $event)"
                    ...
                    >
                      ...
                      <div class="item-actions">
                        <div class="item-action-icon" @click.stop="handleSelectQuickReply(item)">
                          <svg width="16" height="16" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg">
                            <path d="M1014.288782 129.308444a42.666667 42.666667 0 0 1 5.802667 45.141334L715.024782 829.610667a42.666667 42.666667 0 0 1-63.146666 16.952889l-234.666667-163.783112a42.666667 42.666667 0 0 1 48.839111-69.973333l193.024 134.741333 245.902222-528.099555L146.875449 408.462222l156.814222 104.248889a42.666667 42.666667 0 0 0 45.056 1.336889l235.719111-137.073778a42.666667 42.666667 0 1 1 42.922667 73.756445l-235.719111 137.102222a128 128 0 0 1-135.253334-4.039111L19.131449 425.984a42.666667 42.666667 0 0 1 13.312-76.942222l938.666667-233.984a42.666667 42.666667 0 0 1 43.207111 14.250666h-0.056889z" fill="#8a8a8a"></path>
                            <path d="M481.439004 686.876444a42.666667 42.666667 0 0 1 1.934223 60.302223l-153.514667 163.783111A42.666667 42.666667 0 0 1 256.045227 881.777778v-163.811556a42.666667 42.666667 0 1 1 85.333333 0v55.893334l79.786667-85.048889a42.666667 42.666667 0 0 1 60.302222-1.934223z" fill="#8a8a8a"></path>
                          </svg>
                        </div>
                        <el-popover
                  ...
                  <div v-else class="empty-group">
                    <div class="empty-icon">
                      <svg width="120" height="120" viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <!-- 盒子底部 -->
                        <path d="M25 50L60 70L95 50V85C95 89.4183 91.4183 93 87 93H33C28.5817 93 25 89.4183 25 85V50Z" fill="url(#emptyBoxGradient)" stroke="#DCDFE6" stroke-width="1.5"/>
                        <!-- 盒子顶部左翼 -->
                        <path d="M25 50L60 30L60 70L25 50Z" fill="url(#emptyBoxGradient)" stroke="#DCDFE6" stroke-width="1.5"/>
                        <!-- 盒子顶部右翼 -->
                        <path d="M95 50L60 30L60 70L95 50Z" fill="url(#emptyBoxShadow)" stroke="#DCDFE6" stroke-width="1.5"/>
                        <!-- 内部线条表示空 -->
                        <path d="M35 58L60 72L85 58" stroke="#C0C4CC" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" opacity="0.5"/>
                        <path d="M35 70L85 70" stroke="#C0C4CC" stroke-width="1.5" stroke-linecap="round" opacity="0.5"/>
                        <path d="M35 78L85 78" stroke="#C0C4CC" stroke-width="1.5" stroke-linecap="round" opacity="0.5"/>
                        <!-- 渐变定义 -->
                        <defs>
                          <linearGradient id="emptyBoxGradient" x1="25" y1="30" x2="95" y2="93" gradientUnits="userSpaceOnUse">
                            <stop offset="0%" stop-color="#FAFBFC" stop-opacity="0.8"/>
                            <stop offset="100%" stop-color="#F5F7FA" stop-opacity="1"/>
                          </linearGradient>
                          <linearGradient id="emptyBoxShadow" x1="60" y1="30" x2="95" y2="50" gradientUnits="userSpaceOnUse">
...
const handleConfirmEditGroup = () => {
  ...
  const exists = quickReplyGroups.value.some(
    (g) => g.name === trimmedName && g.id !== editingGroupId.value
  )
  if (exists) {
    ElMessage.warning('分组名称已存在')
    return
