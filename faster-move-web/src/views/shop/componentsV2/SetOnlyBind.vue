<template>
  <el-dialog v-model="addShopAfterStateCom" :before-close="handleCloseShopAfter" :title="isBind ? '店铺绑定成功' : '店铺添加成功'" width="30%">
    <div>
      <div style="margin-bottom: 15px;">
        <span>店铺名称：</span> {{ props.addShopAfterObj.name }}
      </div>
      <div style="margin-bottom: 15px;">
        <span>门店ID： </span> {{ props.addShopAfterObj.office_id }}
      </div>
