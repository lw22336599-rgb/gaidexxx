    ...
    <div class="shopinformation">
      ...
      <div class="imglist">
        <div style='width: fit-content;display: flex;flex-direction: column;'>
          ...
          <el-button style='margin: auto;' :disabled="!(poiInfo && poiInfo.storeHead && poiInfo.storeHead.storeInfo)"
            :icon="Download" @click="downImg(handlePicUrl(poiInfo.storeHead.storeInfo.storeLogo))">下载店铺logo</el-button>
        </div>
        <div class="boxflexlist">
          ...
          <div style='width: fit-content;display: flex;flex-direction: column;width: 25%;min-width: 350px;'>
            ...
            <el-button style='margin: auto;'
              :disabled="!(poiInfo && poiInfo.storeHead && poiInfo.storeHead.storeHeadPoster)" :icon="Download"
              @click="downImg(handlePicUrl(poiInfo.storeHead.storeHeadPoster.headImage))">下载店铺招牌</el-button>
          </div>
          <div style='width: fit-content;display: flex;flex-direction: column;width: 25%;min-width: 350px;'>
            <div class="imgbox">
              <div class="img">
