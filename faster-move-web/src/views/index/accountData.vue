    ...
    <template #header>
      <div class="header-main">
        ...
        <div class="header-right">
          <div class="right-item right-item-pay-top" :class="{'is-active': currentTab === 1}" @click="getList(1, 'payTop')">消耗积分数</div>|
          <div class="right-item right-item-member-top" :class="{'is-active': currentTab === 2}" @click="getList(2, 'memberTop')">名下成员数</div>|
          <div class="right-item right-item-shop-top" :class="{'is-active': currentTab === 3}" @click="getList(3, 'shopTop')">名下店铺数</div>
        </div>
      </div>
    </template>
