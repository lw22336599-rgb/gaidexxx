  ...
  <div class="notice-container">
    <el-row :gutter="10">
      ...
      <el-col :span="20">
        <div v-if="!isDtManage && oemshow == false" class="table-main">
          <div class="table-tips" style="height: 10px" />
          <div class="table-tools">
            <div v-if="!openFeedback" class="buton pointer" @click="addNotice">
              <img alt="" src="/src/icon/addicon.png" />添加{{ queryParams.type === 1 ? '公告' : '日志' }}
            </div>
          </div>
          <div class="table-box">
        ...
        <div v-if="oemshow" class="oembox">
          <div class="addadmin">
            <div class="sbmit1" @click="addadminshow(true)">
              <el-icon color="#ffffff" style="margin-right: 5px"><Plus /></el-icon>添加用户
            </div>
          ...
          <el-table :data="oemtableData" style="width: 100%" height="calc(100vh - 200px)">
            ...
            <el-table-column prop="address" label="操作" align="center" width="180">
              <template #default>
                <div class="butflex">
                  <el-button type="primary" text="primary" style="margin-left: 5px" @click="sunshow = true"
                    >编辑</el-button
                  >
          ...
          <div class="preview-panel">
            ...
            <div class="preview-box">
              <div class="preview-message-box">
                ...
                <div class="preview-content" v-html="formatPreviewContent(ruleForm.name)" />
    ...
    <el-dialog v-model="adminshow" width="36%" :show-close="false">
      <template #header>
        <div class="my-header">
          <div class="adduserbox">
            <el-icon style="margin-right: 5px" color="#5391f7"><Folder /></el-icon>添加用户
          </div>
          <div />
        </div>
      </template>
      <div>
        ...
        <el-input v-model="userfrom.userId" placeholder="请输入用户id" />
        <div style="margin: 10px">可贴牌的应用数:</div>
        <el-input v-model="userfrom.userId" placeholder="请输入可贴牌的应用数" />
        <div style="margin: 10px">分配的登录网址:</div>
        <el-input v-model="userfrom.userId" placeholder="请输入分配的登录网址" />
      </div>
      <div class="flexbox">
        ...
        <div class="imgboxflex" style="display: flex; justify-content: center; align-self: center">
          <el-form-item label="软件logo:">
            ...
            >
              ...
              <div
                v-else
                style="width: 178px; height: 178px; display: flex; align-items: center; justify-content: center"
              >
          ...
          <div>
            ...
            <el-form-item>
              ...
              >
                ...
                <div
                  v-else
                  style="width: 300px; height: 178px; display: flex; align-items: center; justify-content: center"
                >
                  <el-icon class="avatar-uploader-icon"><Plus /></el-icon>
                </div>
              </el-upload>
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      getlistorderbyctime(this.queryParams)
        .then(res => {
          if (res.code === 200) {
