<template>
  <el-scrollbar ref="scrollbarRef" wrap-class="scroll-wrap" @scroll="handleScroll">
    <div class="vue-shop-vite-box" :class="{ mobile }">
      <component :is="layout" :collapse="collapse" :device="device" :fixed-header="theme.fixedHeader"
    ...
    <CustomerServiceFloatButton @open-chat="handleOpenCustomerService" />

    <!-- 客服聊天抽屉 -->
    <el-drawer v-model="customerServiceDrawerVisible" title="客服系统" :size="mobile ? '100%' : '80%'" :with-header="true"
      :close-on-press-escape="true" :close-on-click-modal="true" class="customer-service-drawer">
      <CustomerServiceChat />
    </el-drawer>
  </el-scrollbar>
</template>
...
import CustomerServiceFloatButton from '/@/customer-service/components/CustomerServiceFloatButton.vue'
import CustomerServiceChat from '/@/customer-service/components/CustomerServiceChat.vue'
